...
void ASteamTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("PrimaryAction", IE_Pressed, this, &ASteamTestCharacter::OnPrimaryAction);
...
void ASteamTestCharacter::OnPrimaryAction()
{
	// Trigger the OnItemUsed Event
	OnUseItem.Broadcast();
}

void ASteamTestCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void ASteamTestCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
bool ASteamTestCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &ASteamTestCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &ASteamTestCharacter::EndTouch);
